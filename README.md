...
В приложении 4 основных раздела, переключаться между когторыми можно с помощью Tab Bar: 
1. Новости
2. Сайт
3. Таблица
4. Монитор
...
Новости представленны в ScrollView виде списка, нажатие на новость направляет на новый экран.
